...
#### <ins>Вычислительная математика</ins>: преподаватель: *Скуднева Екатерина Валентиновна*. Каталог содержит архивы с выполнеными лабораторными работами, а так же программы из курса вычислительной математики, пригодны для использования с c++ (папка CPP). Лабораторные работы выполнялись с использованием g++ и vim. Первая лабораторная работа использует реалезованные на c++ алгоритмы QUANC8 и SPLINE. Вторая лабораторная работа использует алгоритмы DECOMP и SOLVE на Фортране.<br>
#### <ins>Объектно-ориентированное программирование</ins>: преподаватель: *Маслаков Алексей Павлович*. Каталог содержит необязательные задания, выполняемые на практических парах. Задания выполнялись с использованием vim, javac и java<br>
#### <ins>Языки моделирования и описания цифровой аппаратуры</ins>: преподаватель: *Амосов Владимир Владимирович*. Каталог содержит лабораторные работы. 1 и 2 лабораторные работы работают в MaxPlusII и Quartus,... .<br><br>
