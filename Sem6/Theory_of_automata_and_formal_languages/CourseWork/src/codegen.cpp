...
Command::Command(Instruction instruction) : instruction_(instruction), arg_(0) {}

Command::Command(Instruction instruction, int arg) : instruction_(instruction), arg_(arg) {}
...
void Command::print(int address, ostream& os)
{
  ...
  switch (instruction_)
  {
    ...
    case LOAD: os << "LOAD\t" << arg_; break;
    case STORE: os << "STORE\t" << arg_; break;
    case BLOAD: os << "BLOAD\t" << arg_; break;
    case BSTORE: os << "BSTORE\t" << arg_; break;
    case PUSH: os << "PUSH\t" << arg_; break;
    case POP: os << "POP"; break;
    case DUP: os << "DUP"; break;
    case ADD: os << "ADD"; break;
    case SUB: os << "SUB"; break;
    case MULT: os << "MULT"; break;
    case DIV: os << "DIV"; break;
    case INVERT: os << "INVERT"; break;
    case COMPARE: os << "COMPARE\t" << arg_; break;
    case JUMP: os << "JUMP\t" << arg_; break;
    case JUMP_YES: os << "JUMP_YES\t" << arg_; break;
    case JUMP_NO: os << "JUMP_NO\t" << arg_; break;
...
CodeGen::CodeGen(ostream& output) : output_(output) {}
