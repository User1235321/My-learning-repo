...
\restrict g0Ym6Wpj3kyNVVdE3OsIsOx2hz4HncfiT6n7qQ8nNsl2BXJpxOOUH2eXevOxxMQ
...
COPY public.sales (id, good_id, good_counter, create_date) FROM stdin;
\.
...
COPY public.warehouse1 (id, good_id, good_counter) FROM stdin;
\.
...
COPY public.warehouse2 (id, good_id, good_counter) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.warehouse1_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.warehouse2_id_seq', 1, false);
...
\unrestrict g0Ym6Wpj3kyNVVdE3OsIsOx2hz4HncfiT6n7qQ8nNsl2BXJpxOOUH2eXevOxxMQ
