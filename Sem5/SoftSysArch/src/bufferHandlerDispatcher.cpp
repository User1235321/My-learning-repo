...
bufferHandlerDispatcher::bufferHandlerDispatcher(std::vector< handler > & handlers, std::vector< buffer > & buff, std::ostream * out, size_t sleepTime, std::mutex * outMutex):
  handlerNum_(0),
